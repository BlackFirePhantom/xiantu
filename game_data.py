...
TECHNIQUES = {
    ...
    "jichu_tuna":    {"name": "基础吐纳术",   "tier": "黄阶", "desc": "最基础的吐纳之法",
                      ...
                      "skill": {"name": "吐纳回春", "type": "heal", "power": 0.15, "mp_cost": 10, "desc": "恢复15%最大气血"}},
    "lingxi_jue":    {"name": "灵息诀",       "tier": "黄阶", "desc": "感应天地灵气的法诀",
                      ...
                      "skill": {"name": "灵息激荡", "type": "buff", "power": 0.20, "duration": 3, "mp_cost": 12, "target": "atk", "desc": "攻击+20%，持续3回合"}},
    "huntie_gong":   {"name": "混铁功",       "tier": "黄阶", "desc": "锤炼肉身的炼体功法",
                      ...
                      "skill": {"name": "铁甲护体", "type": "defense", "power": 0.40, "duration": 2, "mp_cost": 12, "desc": "减伤40%，持续2回合"}},
    "qingxin_jue":   {"name": "清心诀",       "tier": "黄阶", "desc": "道门入门心法，稳固道心",
                      ...
                      "skill": {"name": "清心凝神", "type": "heal", "power": 0.20, "mp_cost": 15, "desc": "恢复20%最大气血"}},
    "modao_rumen":   {"name": "魔道入门",     "tier": "黄阶", "desc": "魔道基础功法，以杀证道",
                      ...
                      "skill": {"name": "魔气斩", "type": "attack", "power": 1.3, "mp_cost": 10, "desc": "造成130%攻击力的伤害"}},
    # ── 玄阶·进阶 ──
    "qingyun_jue":   {"name": "青云诀",       "tier": "玄阶", "desc": "青云镇不传之秘",
                      ...
                      "skill": {"name": "青云护体", "type": "buff", "power": 0.30, "duration": 3, "mp_cost": 18, "target": "def", "desc": "防御+30%，持续3回合"}},
    "xuantian_gong": {"name": "玄天功",       "tier": "玄阶", "desc": "玄天正宗的镇派功法",
                      ...
                      "skill": {"name": "玄天罡气", "type": "buff", "power": 0.15, "duration": 3, "mp_cost": 25, "target": "all", "desc": "攻防+15%，持续3回合"}},
    "pozhen_jianfa": {"name": "破阵剑法",     "tier": "玄阶", "desc": "以力破巧的刚猛剑法",
                      ...
                      "skill": {"name": "破阵一剑", "type": "attack", "power": 1.5, "mp_cost": 18, "desc": "造成150%攻击力的伤害"}},
    "lieyan_jue":    {"name": "烈焰诀",       "tier": "玄阶", "desc": "火属性功法，灵力化为烈焰",
                      ...
                      "skill": {"name": "烈焰掌", "type": "attack", "power": 1.6, "mp_cost": 20, "desc": "造成160%攻击力的火焰伤害"}},
    "hanbing_jue":   {"name": "寒冰诀",       "tier": "玄阶", "desc": "水属性功法，灵力化为寒冰",
                      ...
                      "skill": {"name": "寒冰诅咒", "type": "debuff", "power": 0.30, "duration": 2, "mp_cost": 18, "target": "monster_atk", "desc": "怪物攻击-30%，持续2回合"}},
    "kumu_jue":      {"name": "枯木诀",       "tier": "玄阶", "desc": "木属性功法，生生不息",
                      ...
                      "skill": {"name": "枯木逢春", "type": "heal", "power": 0.25, "mp_cost": 20, "desc": "恢复25%最大气血"}},
    "shagui_jue":    {"name": "煞鬼诀",       "tier": "玄阶", "desc": "鬼道功法，操控阴煞之气",
                      ...
                      "skill": {"name": "煞鬼噬魂", "type": "lifesteal", "power": 1.2, "lifesteal_pct": 0.30, "mp_cost": 20, "desc": "造成120%伤害并吸取30%气血"}},
    # ── 地阶·高阶 ──
    "jiuyang_gong":  {"name": "九阳功",       "tier": "地阶", "desc": "至阳至刚的绝世功法",
                      ...
                      "skill": {"name": "九阳神掌", "type": "attack", "power": 1.8, "mp_cost": 30, "desc": "造成180%攻击力的至阳伤害"}},
    "taiyi_jue":     {"name": "太乙诀",       "tier": "地阶", "desc": "道门正宗的无上法诀",
                      ...
                      "skill": {"name": "太乙金身", "type": "defense", "power": 0.50, "duration": 3, "mp_cost": 28, "desc": "减伤50%，持续3回合"}},
    "tianmo_gong":   {"name": "天魔功",       "tier": "地阶", "desc": "魔道至高功法，威力惊人",
                      ...
                      "skill": {"name": "天魔三击", "type": "multi_hit", "power": 0.8, "hits": 3, "mp_cost": 30, "desc": "连续攻击3次，每次80%攻击力"}},
    "wuxing_huanhua":{"name": "五行幻化术",   "tier": "地阶", "desc": "以五行之力幻化万物",
                      ...
                      "skill": {"name": "五行护体", "type": "buff", "power": 0.25, "duration": 3, "mp_cost": 30, "target": "all", "desc": "攻防+25%，持续3回合"}},
    "poxu_jianfa":   {"name": "破虚剑法",     "tier": "地阶", "desc": "一剑破虚空的绝世剑法",
                      ...
                      "skill": {"name": "破虚一剑", "type": "attack", "power": 2.0, "mp_cost": 28, "desc": "造成200%攻击力的破灭伤害"}},
    "bubu_shenghua": {"name": "步步生花",     "tier": "地阶", "desc": "木属性至高功法，脚下花开，万物复苏",
                      ...
                      "skill": {"name": "百花回春", "type": "heal", "power": 0.35, "mp_cost": 25, "desc": "恢复35%最大气血"}},
    # ── 天阶·绝世 ──
    "hundun_jue":    {"name": "混沌诀",       "tier": "天阶", "desc": "上古大能遗留的无上功法",
                      ...
                      "skill": {"name": "混沌一击", "type": "attack", "power": 2.2, "mp_cost": 40, "desc": "造成220%攻击力的混沌伤害"}},
    "lunhui_jue":    {"name": "轮回诀",       "tier": "天阶", "desc": "参悟生死轮回，超脱三界",
                      ...
                      "skill": {"name": "轮回逆转", "type": "heal", "power": 1.0, "mp_cost": 45, "desc": "气血完全恢复"}},
    "tianmo_bian":   {"name": "天魔变",       "tier": "天阶", "desc": "化身天魔，万法不侵",
                      ...
                      "skill": {"name": "天魔四击", "type": "multi_hit", "power": 1.0, "hits": 4, "mp_cost": 40, "desc": "连续攻击4次，每次100%攻击力"}},
    "jiujian_xianfa":{"name": "九剑仙法",     "tier": "天阶", "desc": "传说中的仙人剑法，九剑合一",
                      ...
                      "skill": {"name": "九剑归一", "type": "attack", "power": 2.5, "mp_cost": 35, "desc": "造成250%攻击力的灭世伤害"}},
    "qingyun_midian":{"name": "青云秘典",     "tier": "天阶", "desc": "青云宗镇宗之宝，历代真传弟子方可修习",
                      ...
                      "skill": {"name": "青云无量", "type": "buff", "power": 0.40, "duration": 3, "mp_cost": 35, "target": "all", "desc": "攻防+40%，持续3回合"}},
}
...
MONSTERS = {
    "green_wolf":        {"name": "青狼",       "hp": 20,  "atk": 5,  "def": 2,  "exp": 10,  "gold": 5,   "level": 1,  "level_range": (1, 3),  "element": "木",
                          "skills": [{"name": "嚎叫", "type": "buff", "power": 0.20, "duration": 2, "chance": 0.15, "target": "atk", "desc": "攻击力提升"}]},
    "spirit_slime":      {"name": "灵液怪",     "hp": 15,  "atk": 4,  "def": 1,  "exp": 8,   "gold": 4,   "level": 1,  "level_range": (1, 2),  "element": "水",
                          "skills": [{"name": "分裂自愈", "type": "heal", "power": 0.10, "chance": 0.15, "desc": "恢复少量气血"}]},
    "poison_snake":      {"name": "毒蟒",       "hp": 18,  "atk": 7,  "def": 1,  "exp": 12,  "gold": 6,   "level": 1,  "level_range": (1, 3),  "element": "木",
                          "skills": [{"name": "毒咬", "type": "attack", "power": 1.2, "chance": 0.20, "debuff": {"target": "player_def", "mult": 0.8, "rounds": 2}, "desc": "中毒防御下降"}]},
    ...
    "wild_boar":         {"name": "鬃毛野猪",   "hp": 30,  "atk": 8,  "def": 4,  "exp": 15,  "gold": 8,   "level": 2,  "level_range": (1, 3),  "element": "土",
                          "skills": [{"name": "冲撞", "type": "attack", "power": 1.3, "chance": 0.20, "desc": "猛烈冲撞"}]},
    "rogue_cultivator":  {"name": "散修",       "hp": 25,  "atk": 10, "def": 3,  "exp": 18,  "gold": 15,  "level": 2,  "level_range": (1, 4),  "element": None,
                          "skills": [{"name": "剑气斩", "type": "attack", "power": 1.4, "chance": 0.20, "desc": "释放剑气"}]},
    "blood_bat":         {"name": "噬血蝠",     "hp": 16,  "atk": 9,  "def": 1,  "exp": 10,  "gold": 5,   "level": 1,  "level_range": (1, 3),  "element": None,
                          "skills": [{"name": "吸血", "type": "lifesteal", "power": 1.0, "lifesteal_pct": 0.30, "chance": 0.20, "desc": "吸取气血"}]},
    "ironback_centipede": {"name": "铁背蜈蚣",  "hp": 22,  "atk": 7,  "def": 5,  "exp": 14,  "gold": 7,   "level": 2,  "level_range": (1, 3),  "element": "金",
                          "skills": [{"name": "铁甲", "type": "defense", "power": 0.30, "duration": 2, "chance": 0.20, "desc": "硬化甲壳"}]},
    "stone_bear":        {"name": "石熊妖",     "hp": 55,  "atk": 16, "def": 8,  "exp": 35,  "gold": 22,  "level": 4,  "level_range": (3, 6),  "element": "土",
                          "skills": [{"name": "岩石护体", "type": "defense", "power": 0.40, "duration": 2, "chance": 0.25, "desc": "岩石护盾"}]},
    "wolf_king":         {"name": "灰鬃狼王",   "hp": 50,  "atk": 18, "def": 6,  "exp": 38,  "gold": 20,  "level": 5,  "level_range": (3, 7),  "element": "木",
                          "skills": [{"name": "群狼嚎叫", "type": "buff", "power": 0.30, "duration": 2, "chance": 0.25, "target": "atk", "desc": "召唤狼群之威"}]},
    "soul_spider":       {"name": "噬魂蛛",     "hp": 42,  "atk": 20, "def": 5,  "exp": 36,  "gold": 18,  "level": 5,  "level_range": (3, 7),  "element": None,
                          "skills": [{"name": "噬魂", "type": "attack", "power": 1.5, "chance": 0.25, "debuff": {"target": "player_atk", "mult": 0.8, "rounds": 2}, "desc": "噬魂夺魄"}]},
    "ancient_tree_demon": {"name": "古树妖",    "hp": 70,  "atk": 14, "def": 12, "exp": 45,  "gold": 28,  "level": 5,  "level_range": (4, 7),  "element": "木",
                          "skills": [{"name": "自愈", "type": "heal", "power": 0.15, "chance": 0.25, "desc": "汲取大地之力恢复"}]},
    "rock_beast":        {"name": "岩角兽",     "hp": 40,  "atk": 13, "def": 8,  "exp": 22,  "gold": 12,  "level": 4,  "level_range": (3, 5),  "element": "土",
                          "skills": [{"name": "岩突", "type": "attack", "power": 1.3, "chance": 0.25, "desc": "地刺突袭"}]},
    "wind_yao":          {"name": "风翼妖",     "hp": 48,  "atk": 20, "def": 5,  "exp": 32,  "gold": 22,  "level": 5,  "level_range": (3, 6),  "element": None,
                          "skills": [{"name": "旋风", "type": "multi_hit", "power": 0.8, "hits": 2, "chance": 0.25, "desc": "旋风连击"}]},
    "purple_eagle":      {"name": "紫云鹰",     "hp": 45,  "atk": 18, "def": 5,  "exp": 30,  "gold": 20,  "level": 5,  "level_range": (4, 6),  "element": None,
                          "skills": [{"name": "撕裂", "type": "attack", "power": 1.4, "chance": 0.25, "desc": "利爪撕裂"}]},
    "mine_demon_chief":  {"name": "妖兵统领",   "hp": 90,  "atk": 25, "def": 10, "exp": 60,  "gold": 45,  "level": 7,  "level_range": (6, 9),  "element": None,
                          "skills": [{"name": "统领号令", "type": "buff", "power": 0.25, "duration": 2, "chance": 0.30, "target": "all", "desc": "号令三军攻防提升"}]},
    "cave_troll_yao":    {"name": "洞穴巨妖",   "hp": 110, "atk": 28, "def": 14, "exp": 72,  "gold": 55,  "level": 8,  "level_range": (6, 10), "element": "土",
                          "skills": [{"name": "巨力重击", "type": "attack", "power": 1.6, "chance": 0.30, "desc": "毁灭性重击"}]},
    "demonic_cultivator": {"name": "魔修",      "hp": 120, "atk": 35, "def": 12, "exp": 100, "gold": 80,  "level": 10, "level_range": (8, 12), "element": None,
                          "skills": [{"name": "魔气斩", "type": "attack", "power": 1.7, "chance": 0.35, "desc": "魔气凝聚一击"},
                                     {"name": "噬魔", "type": "lifesteal", "power": 1.2, "lifesteal_pct": 0.30, "chance": 0.20, "desc": "吞噬对方精气"}]},
    "shadow_demon":      {"name": "魔族修士",   "hp": 140, "atk": 38, "def": 15, "exp": 110, "gold": 90,  "level": 11, "level_range": (9, 13), "element": None,
                          "skills": [{"name": "暗影突袭", "type": "attack", "power": 1.8, "chance": 0.35, "desc": "从暗影中突袭"},
                                     {"name": "影遁", "type": "defense", "power": 0.50, "duration": 1, "chance": 0.20, "desc": "化为暗影闪避"}]},
    "flood_dragon":      {"name": "蛟龙",       "hp": 180, "atk": 45, "def": 20, "exp": 180, "gold": 150, "level": 13, "level_range": (11, 14),"element": "水",
                          "skills": [{"name": "兴风作浪", "type": "multi_hit", "power": 0.9, "hits": 3, "chance": 0.35, "desc": "掀起狂风巨浪"},
                                     {"name": "龙息", "type": "attack", "power": 2.0, "chance": 0.25, "desc": "喷射龙息"}]},
    "ancient_true_dragon":{"name": "上古真龙",  "hp": 300, "atk": 60, "def": 30, "exp": 400, "gold": 300, "level": 15, "level_range": (13, 15),"element": "火",
                          "skills": [{"name": "龙息", "type": "attack", "power": 2.2, "chance": 0.40, "desc": "焚天龙息"},
                                     {"name": "龙啸", "type": "buff", "power": 0.50, "duration": 2, "chance": 0.25, "target": "atk", "desc": "龙啸九天"},
                                     {"name": "真龙之躯", "type": "defense", "power": 0.50, "duration": 2, "chance": 0.20, "desc": "龙鳞护体"}]},
}
# ═══════════════ 物品 ═══════════════
ITEMS = {
    # ── 丹药·恢复气血 ──
